...
'''
Description
    This code is used to read the results generated by read_debris_case.py and to generate figures from them.
Author
    Álvaro González Bilbao alvaro.gonzalez.bilbao@gmail.com

@version: 1.13 (22/06/21)
'''
...
##########################################  plot functions  ##############################################################
        ...
        def plot_deltac0max_image(self,t_final,im_name,nx,ny,off_x = 0,off_y = 0,clipp = False, xmin=0, xmax=0, ymin=0, ymax=0, figsize_x = 8, figsize_y = 8,n_intervals = 8, save = False):
                self.plot_fieldmax_image(self.deltac0,t_final,im_name,nx,ny,'erosion depth', 'm',off_x, off_y, clipp, xmin, xmax, ymin, ymax, figsize_x, figsize_y, n_intervals, save,-1)
        ...
        def plot_deltah0max_image(self,t_final,im_name,nx,ny,off_x = 0,off_y = 0,clipp = False, xmin=0, xmax=0, ymin=0, ymax=0, figsize_x = 8, figsize_y = 8,n_intervals = 8, save = False):
                self.plot_fieldmax_image(self.deltah0,t_final,im_name,nx,ny,'erosion depth', 'm',off_x, off_y, clipp, xmin, xmax, ymin, ymax, figsize_x, figsize_y, n_intervals, save,-1)
